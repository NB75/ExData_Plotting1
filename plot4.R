...
#plot2
plot(1,type="n",xlab="datetime",ylab="Voltage",ylim=c(232,248),xlim=c(0,lines),xaxt="n")
axis(1,at=c(0,mid,lines),labels = c("Thu","Fri","Sat"))
lines(filter_df$Voltage)
...
#plot4
plot(1,type="n",xlab="datetime",ylab="Global_reactive_power",ylim=c(0,0.5),xlim=c(0,lines),xaxt="n")
axis(1,at=c(0,mid,lines),labels = c("Thu","Fri","Sat"))
lines(filter_df$Global_reactive_power)
